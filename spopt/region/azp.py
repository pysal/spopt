...
from spopt.region.azp_util import AllowMoveStrategy, \
                                            AllowMoveAZP,\
                                            AllowMoveAZPSimulatedAnnealing
from spopt.region.util import array_from_df_col, array_from_dict_values, \
...
class AZP(BaseSpOptHeuristicSolver):
    ...
    def solve(self):
        ...
        model.fit_from_w( self.w, X, self.n_clusters, \
            initial_labels=self.initial_labels, objective_func=self.objective_func)
