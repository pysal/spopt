...
project = "spopt"  # string of your project name, for example, 'giddy'
...
#
# The full version.
version = spopt.__version__ #should replace it with your spopt
release = spopt.__version__ #should replace it with your spopt
...
latex_documents = [
    (master_doc, 'spopt.tex', u'spopt Documentation',
...
man_pages = [
    (master_doc, 'spopt', u'spopt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spopt', u'spopt Documentation',
     author, 'spopt', 'One line description of project.',
     'Miscellaneous'),
]
